...
- `npm run generate:slice feature/page/..? name`
...
2. Состояние (on\off)
```
npm run remove-feture isRepoRatingEnabled on
```
...
- [repoEditForm](/src/features/repoEditForm)
- [repoRating](/src/features/repoRating)
- [repoRecommendationsList](/src/features/repoRecommendationsList)
- [AuthByUsername](/src/features/AuthByUsername)
- [avatarDropdown](/src/features/avatarDropdown)
- [settingsProfile](/src/features/settingsProfile)
